...
export default function ClaimGymPage() {
  ...
  if (!gym) {
    return (
      <div className="max-w-md mx-auto px-6 py-20 text-center">
        ...
        <Link href="/gyms" className="text-brand-text dark:text-blue-400 hover:underline">← Back to all gyms</Link>
      </div>
    );
  }
  ...
  if (gym.ownerID) {
    return (
      <div className="max-w-md mx-auto px-6 py-20 text-center">
        ...
        <Link href="/owner/login" className="text-brand-text dark:text-blue-400 hover:underline">Go to owner sign-in →</Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-md mx-auto px-6 py-16">
      <Link href={`/gyms/${gymId}`} className="text-sm font-semibold text-gray-500 dark:text-gray-400 hover:text-brand-text dark:hover:text-blue-400 transition">← Back to {gym.gymName}</Link>
